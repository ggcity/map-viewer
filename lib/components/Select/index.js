...
export default class {
  ...
  get contextMenu() {
    ...
    if (ops.includes('dataTable')) {
      ...
      const dataSpace = document.createElement('section');
      const dataSpaceHeader = document.createElement('section');
      const dataSpaceContent = document.createElement('section')
      dataSpace.appendChild(dataSpaceHeader);
      dataSpace.appendChild(dataSpaceContent)

      dataSpace.classList.add('data-space');
      dataSpaceHeader.classList.add('data-space-header');
      dataSpaceContent.classList.add('data-space-content')
      ...
      this._contextMenu.querySelector('.select-operations').appendChild(dataTableWidgetButton);
    }
