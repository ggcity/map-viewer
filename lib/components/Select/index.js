...
export default class {
  ...
  get popup() {
    ...
    this._popupElement.classList.add('ol-popup');
  ...
  async _setupWidget(viewer, widgetConfig) {
    const { default: popupFunction } = await import(widgetConfig.customPopupTemplate);
    ...
    viewer.map.on('click', event => {
      ...
      //this._popupElement.style.width = this._popupContent.scrollWidth + 'px';
