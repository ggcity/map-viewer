...
export default class {
    ...
    this._contextMenu.innerHTML = /*html*/`
      <div class="mdc-top-app-bar__row">
        ...
        <section class="mdc-top-app-bar__section mdc-top-app-bar__section--align-end" role="toolbar">
          <button class="material-symbols-rounded mdc-top-app-bar__action-item mdc-icon-button mdc-ripple-surface" aria-label="Data Table" title="Data Table">table_chart</button>
          <button class="material-symbols-rounded mdc-top-app-bar__action-item mdc-icon-button mdc-ripple-surface" aria-label="Buffer Select" title="Buffer Select">blur_circular</button>
  ...
  _popupControls(features) {
    ...
    dataButton.textContent = 'data_info_alert';
